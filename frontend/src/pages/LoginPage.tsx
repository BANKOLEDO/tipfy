      ...
      <div className="w-full max-w-4xl mx-auto px-5 sm:px-8 flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
        ...
        <div className="w-full lg:w-[42%] max-w-[380px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 mt-6">
            ...
            />
            <Input
              light label="Password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password"
          ...
          <div className="mt-6 pt-5 border-t border-gray-200 text-center">
            <Link to="/register" className="text-xs text-gray-500 hover:text-dark-text transition-colors">
